--[[
    ...
    Github: https://github.com/Footagesus/ArtUI
...
local B=v.Object:FindFirstChild"ArtUIGradient"
if B then
B:Destroy()
end
...
local M="ArtUI/"..C.."/assets/."..F.."-"..x..".png"
...
warn(string.format("[ ArtUI.Creator ] Failed to load custom asset '%s': %s",M,tostring(P)))
L:Destroy()
...
if not N then
warn("[ ArtUI.Creator ]  '"..identifyexecutor().."' doesnt support the URL Images. Error: "..O)
...
return[[
{
    ...
    "version": "1.6.64",
    "main": "./dist/main.lua",
    "repository": "https://github.com/Footagesus/ArtUI",
    "discord": "https://discord.gg/ftgs-development-hub-1300692552005189632",
    "author": "Footagesus",
...
local ak=a.load'm'.Init(nil,ag.ArtUI.ScreenGui.KeySystem)
...
local g=ag.ArtUI.Services[f.Type]
if g then
local h={}
...
local ag=a.load'm'.Init(nil,ae.ArtUI.ScreenGui.Popups)
...
warn"[ ArtUI.ConfigManager ] Window.Folder is not specified."
return false
end

ac=af
ad.Folder=ac.Folder
ad.Path="ArtUI/"..tostring(ad.Folder).."/config/"

if not isfolder("ArtUI/"..ad.Folder)then
makefolder("ArtUI/"..ad.Folder)
if not isfolder("ArtUI/"..ad.Folder.."/config/")then
makefolder("ArtUI/"..ad.Folder.."/config/")
end
end
...
warn"[ ArtUI.ConfigManager ] The config system doesn't work in the studio."
return nil
end
...
if ak then
if ac.Debug then print("[ ArtUI.ConfigManager ] AutoLoaded config: "..af)end
else
warn("[ ArtUI.ConfigManager ] Failed to AutoLoad config: "..af.." - "..tostring(al))
end
end)
end
end
...
as.Load(al,ar.Content,as.Elements,ak.Window,ak.ArtUI,function()
...
warn("[ ArtUI ] Failed to apply pending config for '"..ar.Flag.."': "..tostring(ay))
end
end)
end
end
...
az.Load(ap,ap.UIElements.ContainerFrame,az.Elements,Window,ArtUI,nil,az,ao)
...
if au.Folder then
if not isfolder("ArtUI/"..au.Folder)then
makefolder("ArtUI/"..au.Folder)
end
if not isfolder("ArtUI/"..au.Folder.."/assets")then
makefolder("ArtUI/"..au.Folder.."/assets")
end
...
if not g then
warn("[ ArtUI.Window.Background ] Failed to download video: "..tostring(h))
return
end
end
...
if not g then
warn("[ ArtUI.Window.Background ] Failed to load custom asset: "..tostring(h))
return
end
warn"[ ArtUI.Window.Background ] VideoFrame may not work with custom video"
b=h
end
...
local l=0
local m=au.UIElements.Main.Main.Topbar.Right.UIListLayout.AbsoluteContentSize.X/as.ArtUI.UIScale





l=au.UIElements.Main.Main.Topbar.Left.AbsoluteSize.X/as.ArtUI.UIScale
...
0,
l+(au.UIPadding/as.ArtUI.UIScale),
0.5,
0
)
au.UIElements.Main.Main.Topbar.Center.Size=UDim2.new(
1,
-l-m-((au.UIPadding*2)/as.ArtUI.UIScale),
1,
0
)
end)
...
au.UIElements.Main.Main.Topbar.Left.Position=UDim2.new(0,(au.UIElements.Main.Main.Topbar.Right.AbsoluteSize.X/as.ArtUI.UIScale)+au.UIPadding-4,0,0)
end)
end
...
ImageTransparency=au.Transparent and as.ArtUI.TransparencyValue or 0
},{
m
})
end
...
au.Destroyed=true
task.wait(0.4)
as.ArtUI.ScreenGui:Destroy()
as.ArtUI.NotificationGui:Destroy()
as.ArtUI.DropdownGui:Destroy()
as.ArtUI.TooltipGui:Destroy()
...
au.Transparent=u
as.ArtUI.Transparent=u

au.UIElements.Main.Background.ImageTransparency=u and as.ArtUI.TransparencyValue or 0
...
return as.ArtUI.UIScale
end

function au.SetUIScale(r,u)
as.ArtUI.UIScale=u
am(as.ArtUI.UIScaleObj,.2,{Scale=u},Enum.EasingStyle.Quint,Enum.EasingDirection.Out):Play()
return au
end
...
local r=a.load'V'
local u=a.load'W'
local v=r.Init(au,as.ArtUI,as.ArtUI.TooltipGui)
...
return v.New(B,as.ArtUI.UIScale)
end
...
return u.New(B,au.UIElements.SideBar.Frame,au.Folder,as.ArtUI.UIScale,au)
end
...
local S=L.AbsoluteContentSize.X/as.ArtUI.UIScale
local T=M.AbsoluteSize.X/as.ArtUI.UIScale
...
local _=Y.AbsoluteSize.X/as.ArtUI.UIScale
if _<W then
W=_
V=Y
end
