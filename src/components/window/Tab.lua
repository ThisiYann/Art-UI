...
function TabModule.Init(WindowTable, ArtUITable, ToolTipParent, TabHighlight)
    Window = WindowTable
    ArtUI = ArtUITable
...
function TabModule.New(Config, UIScale)
    ...
    ElementsModule.Load(Tab, Tab.UIElements.ContainerFrame, ElementsModule.Elements, Window, ArtUI, nil, ElementsModule, UIScale)
